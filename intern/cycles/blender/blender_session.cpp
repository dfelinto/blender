...
static void populate_bake_data(BL::RenderEngine b_engine, BakeData *data, const int object_id, BL::BakePixel pixel_array, const int num_pixels)
{
...
void BlenderSession::bake(BL::Object b_object, const string& pass_type, const int object_id, BL::BakePixel pixel_array, const size_t num_pixels, const int /*depth*/, float result[])
{
	...
	populate_bake_data(b_engine, bake_data, object_id, pixel_array, num_pixels);
