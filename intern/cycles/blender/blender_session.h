...
public:
	...
	void bake(BL::Object b_object, const string& pass_type, const int custom_flag, const int object_id, BL::BakePixel pixel_array, const size_t num_pixels, const int depth, float pixels[]);
