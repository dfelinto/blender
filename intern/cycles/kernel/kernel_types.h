...
#define BAKE_FILTER_DIFFUSE_DIRECT (\
    BAKE_FILTER_DIRECT + \
    BAKE_FILTER_DIFFUSE)

#define BAKE_FILTER_GLOSSY_DIRECT (\
    BAKE_FILTER_DIRECT + \
    BAKE_FILTER_GLOSSY)

#define BAKE_FILTER_TRANSMISSION_DIRECT (\
    BAKE_FILTER_DIRECT + \
    BAKE_FILTER_TRANSMISSION)

#define BAKE_FILTER_SUBSURFACE_DIRECT (\
    BAKE_FILTER_DIRECT + \
    BAKE_FILTER_SUBSURFACE)

#define BAKE_FILTER_DIFFUSE_INDIRECT (\
    BAKE_FILTER_INDIRECT + \
    BAKE_FILTER_DIFFUSE)

#define BAKE_FILTER_GLOSSY_INDIRECT (\
    BAKE_FILTER_INDIRECT + \
    BAKE_FILTER_GLOSSY)

#define BAKE_FILTER_TRANSMISSION_INDIRECT (\
    BAKE_FILTER_INDIRECT + \
    BAKE_FILTER_TRANSMISSION)

#define BAKE_FILTER_SUBSURFACE_INDIRECT (\
    BAKE_FILTER_INDIRECT + \
    BAKE_FILTER_SUBSURFACE)
