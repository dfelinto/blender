...
float (*BKE_editmesh_vertexCos_get(BMEditMesh *em, Scene *scene, SceneLayer *sl, int *r_numVerts))[3]
{
	...
	cage = editbmesh_get_derived_cage_and_final(scene, sl, em->ob, em, CD_MASK_BAREMESH, &final);
