...
static void fh_node_vector_input_expand_in_mf_network(
    blender::nodes::NodeMFNetworkBuilder &builder)
{
  ...
  builder.construct_and_set_matching_fn<blender::fn::CustomMF_Constant<blender::float3>>(
      blender::float3(vector[0], vector[1], vector[2]));
}
...
void register_node_type_fn_input_vector()
{
  ...
  ntype.expand_in_mf_network = fh_node_vector_input_expand_in_mf_network;
