...
typedef struct RenderEngineType {
	...
	void (*bake)(struct RenderEngine *engine, struct Scene *scene, struct Object *object, const int pass_type, const int custom_flag, const int object_id, const struct BakePixel *pixel_array, const int num_pixels, const int depth, void *result);
